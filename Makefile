...
SOURCES=$(SRC_FOLDER)/eval/tinyxml2.cpp $(SRC_FOLDER)/eval/WindScenario.cpp $(SRC_FOLDER)/eval/WindFarmLayoutEvaluator.cpp $(SRC_FOLDER)/eval/KusiakLayoutEvaluator.cpp $(SRC_FOLDER)/GA.cpp
